...
//   it("debe retornar el tipo 'id' para un selector de id", function () {
//     var selector = "#myId";
//     expect(selectorTypeMatcher(selector)).toEqual("id");
//   });

//   it("debe retornar el tipo 'class' para un selector de clase", function () {
//     var selector = ".myClass";
//     expect(selectorTypeMatcher(selector)).toEqual("class");
//   });

//   it("debe retornar el tipo 'tag.class' para un selector de tag.class", function () {
//     var selector = "div.myClass";
//     expect(selectorTypeMatcher(selector)).toEqual("tag.class");
//   });

//   it("debe retornar el tipo 'tag' para un selector de tag", function () {
//     var selector = "div";
//     expect(selectorTypeMatcher(selector)).toEqual("tag");
//   });

//   it("debe retornar el tipo 'attribute' para un selector de atributo", function () {
//     var selector = "[type='submit']";
//     expect(selectorTypeMatcher(selector)).toEqual("attribute");
//   });
// });
...
//   it("debería seleccionar elementos que coincidan con la función de coincidencia proporcionada", function() {
//     elements = traverseDomAndCollectElements(function(el) {
//       return el.tagName.toLowerCase() === 'h2' && el.classList.contains('small');
//     });
//     expect(elements.length).toEqual(2);
//   });

//   it("debería seleccionar elementos que coincidan con la función de coincidencia proporcionada (ejemplo personalizado)", function() {
//     elements = traverseDomAndCollectElements(function(el) {
//       return el.tagName.toLowerCase() === 'div' && el.id === 'myId';
//     });
//     expect(elements.length).toEqual(1);
//   });
...
// describe("Credito Extra", function () {
//   describe("Selector de Jerarquía", function (){
//     it("debe seleccionar los elementos correctos cuando el selector de jerarquía 'div > img'", function () {
//         elements = $('div > img');
...
//     it("debe seleccionar los elementos correctos cuando el selector  con el selector de jerarquía 'div img'", function () {
//         elements = $('body p');
//         expect(elements.length).toEqual(2);
